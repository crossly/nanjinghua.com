...
- 0 个真人语音样本。
- 已部署源代码提交：`76e855f73e76eaa376981fc93461456d4e0e4747`。
- Cloudflare Worker Version ID：`39918078-a466-4692-86c4-a30377c9adca`，创建于 `2026-07-22T02:46:35.401781Z`。
- Cloudflare Deployment ID：`6ccd5071-6b16-454f-a49c-16d859b5057c`，自 `2026-07-22T02:46:36.404303Z` 起承载 100% 流量。
...
- [固定三网恢复复验](./2026-07-20-mainland-recovery-recheck.md)已将移动回归点固定到上海：首个窗口 36/36 通过，第二窗口为 35/36；把 `www` 设为规范内容域后的第三窗口只有 24/36，上海移动对 `www` 的 12 次请求全部超时。裸域规范修复部署后，本记录中的新窗口为 36/36，但标准 Cloudflare 路径仍未通过跨时间稳定性和真实终端验收。
